...
public class LoginActivity extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button signInPangkalan = (Button) findViewById(R.id.sign_pangkalan);
        ...
        signInPangkalan.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Intent i = new Intent(LoginActivity.this, LoginPangkalanActivity.class);
                startActivity(i);
            }
        });
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            if (result.isSuccess()) {
                ...
                // ...
                Toast.makeText(LoginActivity.this, "Pilih email yang ingin digunakan", Toast.LENGTH_LONG).show();
            }
        }
    }
